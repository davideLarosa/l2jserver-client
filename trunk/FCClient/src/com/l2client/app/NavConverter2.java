...
import com.l2client.navigation.NavMeshGenerator;
 ...
 */
public class NavConverter2 {
	
	private static String fileEnding = ".obj";
	...
	public static void main(String[] args) throws Throwable {
		...
		if (!file.isDirectory()) {
			if(navFileFilter.accept(file.getParentFile(), file.getName())){
				NavConverter2 com = new NavConverter2();
				com.convertNav(file);
			} else {
