...
uniform vec2 m_ScrollDirection;
...
void main(){
   ...
   texCoord = inTexCoord;
   vec2 sDir = (m_ScrollSpeed * g_Time * m_ScrollDirection);
   texCoord.x = fract(texCoord.x * sDir.x);
   texCoord.y = fract(texCoord.y * sDir.y);
   #ifdef SEPARATE_TEXCOORD
      texCoord2 = inTexCoord2;
      texCoord2.x = fract(texCoord2.x * sDir.x);
      texCoord2.y = fract(texCoord2.y * sDir.y);
   #endif
