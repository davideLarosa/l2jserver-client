 ...
 */
public class NavConverter3 {
	
	private static String fileEnding = "nav.obj";//nav2 is l2j tiles smaller navs (optimized), no changes in own tiles
